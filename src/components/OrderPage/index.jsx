...
import { Checkbox, Click__here, Container, Have__a__coupon__code, Input, Inputs, Left, Nav_item, Notes, Payement__wrapper, Payment__methods, Payment__title, Paypals, Place__order, Right, Right__card, Right__card__count, Right__card__desc, Right__card__img, Right__card__price, Right__card__title, Right__card__wrapper, Right__Flex__item, Right__Flex__item2, Right__flex__price, Right__flex__right, Right__flex__title, Right__flex__view, Right__right__wrapper, Right__title, Right__total, Right__total__subtotal, Wrapper } from './style'
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <Right>
          ...
          <Have__a__coupon__code>Have a coupon code? <Click__here> Click here</Click__here></Have__a__coupon__code>
          <Right__right__wrapper>
            <Right__flex__right>
              ...
              <Place__order onClick={() => setOrder(true)}>Place Order</Place__order>
            </Right__flex__right>
          </Right__right__wrapper>
        </Right>
      </Wrapper>
